...
include("SDMN_CheckerBot-patch-1/config/config.php");
include("SDMN_CheckerBot-patch-1/config/variables.php");
include("SDMN_CheckerBot-patch-1/functions/bot.php");
include("SDMN_CheckerBot-patch-1/functions/db.php");
include("SDMN_CheckerBot-patch-1/functions/functions.php");
